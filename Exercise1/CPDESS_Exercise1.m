...
Q = 1e8*FEM_create_matrices_mass_part(Mesh, xr{1}, yr{1});
R = eye(m);
...
dT = OCP_compute_dtemperature(time, E, A, B, gradU, LU);
...
for ii = 1:length(beta_list)
    ...
    T1 = OCP_compute_temperature(time, X0, E, A, Bd, B, U1, LU);
